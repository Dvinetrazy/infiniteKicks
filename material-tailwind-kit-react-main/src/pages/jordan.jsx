...
import { featuresData, featuresDatas, teamData, contactData,  datajordan } from "@/data";
  ...
  return (
     ...
     <div className="px-4 pt-20 pb-48">
      <div className="container mx-auto" style={{ marginLeft: '80px', position: 'absolute' }}>
        <h4 className="font-poppins">
          <Link to="/home">Home</Link> {'>'} Nike Jordan
        </h4>
      </div>
    </div>  
    ...
    <section className="px-1 pt-8">
        <div className="container mx-auto">
          ...
          <img src="/img/jordan/jordan_banner.png" className="absolute w-full object-cover" width={'2100px'} style={{ marginBottom: '-440px' }} />
        </div>
        </div>
        </section>
        </div>
