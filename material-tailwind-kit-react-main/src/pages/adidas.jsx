...
import { featuresData, featuresDatas, teamData, contactData, dataadidas, datajordan, dataconvers } from "@/data";
  ...
  return (
    ...
    <section className="px-1 pt-8">
        <div className="container mx-auto">
          ...
          <img src="/img/adidas/adidas_banner.png" className="absolute w-full object-cover" width={'2100px'} style={{ marginBottom: '-440px' }} />
        </div>
        </div>
        </section>
        </div>
